<?php
/*
Identification : index.php(part2)
Author : group19  (Wonjin, Paul)
Purpose : This is the main index page for Part 2 of the project.
*/
...
?>
    <div id="wrapper" class="container">
		<div id="pathList" class="container">
			<form method="POST" id="editPathForm">
				<h2>Select Path to Edit</h2>
				<table border="1">
		...
		<div id="general" style="display: none">
			...
			<FORM method="POST" id="updateGform">
				...
				<table id="table1" border="1">
					<tr><th>Select</th><th>Path Name</th><th>Operating Frequency</th><th>Description</th><th>Note</th></tr>
					<tr>
						<td width='10%'>
							<input type="button" id="editG" name="editG" value="Edit" />
							<input type="submit" id="updateG" name="updateG" value="Update" class="updateButton" />
							<input type="button" id="cancelG" name="cancelG" value="Cancel" class="cancelButton" />
						</td>
...
?>		
		<div id="end" style="display: none">
			...
			<FORM method="POST" id="updateEform">
				...
				<tr><th>Select</th><th>Distance from the start of the path</th><th>Ground height</th><th>Antenna Height</th><th>Cable Type</th><th>Cable Length</th></tr>
...
?>
					...
					<td width="10%">
						<input 
							type="button" 
							id="editE_<?php echo $row['end_id']; ?>" 
							name="editE_<?php echo $row['end_id']; ?>" 
							alt="<?php echo $row['end_id']; ?>"
							value="Edit" /> 	
						<input type="button" id="updateE_<?php echo $row['end_id']; ?>" name="updateE_<?php echo $row['end_id']; ?>" class="updateButton" value="Update" alt="<?php echo $row['end_id']; ?>"/>
						<input type="button" id="cancelE_<?php echo $row['end_id']; ?>" name="cancelE_<?php echo $row['end_id']; ?>" class="cancelButton" value="Cancel" alt="<?php echo $row['end_id']; ?>"/>
					</td>					
...
?>	
		<div id="mid" style="display: none">
			...
			<FORM method="POST" id="updateMform">
				...
				<tr><th>Select</th><th>Distance from the start of the path</th><th>Ground height</th><th>Obstruction Height</th><th>Terrain Type</th><th>Obstruction Type</th></tr>
...
?>
					...
					<td width="10%">
						<input 
							type="button" 
							id="editM_<?php echo $row['mid_id']; ?>" 
							name="editM_<?php echo $row['mid_id']; ?>" 
							alt="<?php echo $row['mid_id']; ?>"
							value="Edit"/>
						<input type="button" id="updateM_<?php echo $row['mid_id']; ?>" name="updateM_<?php echo $row['mid_id']; ?>" class="updateButton" value="Update" alt="<?php echo $row['mid_id']; ?>"/>
						<input type="button" id="cancelM_<?php echo $row['mid_id']; ?>" name="cancelM_<?php echo $row['mid_id']; ?>" class="cancelButton" value="Cancel" alt="<?php echo $row['mid_id']; ?>"/>
</td>
					<td width="10%" id="mid_distance_<?php echo $row['mid_id']; ?>" name="mid_distance_<?php echo $row['mid_id']; ?>"></td>
					<td width="10%" id="mid_ground_height_<?php echo $row['mid_id']; ?>"></td>
					<td width="10%" id="mid_obstruction_height_<?php echo $row['mid_id']; ?>"></td>
					<td width="10%" id="mid_terrain_type_<?php echo $row['mid_id']; ?>"></td>
					<td width="10%" id="mid_obstruction_type_<?php echo $row['mid_id']; ?>"></td>
					</tr>
<?php
}
?>
